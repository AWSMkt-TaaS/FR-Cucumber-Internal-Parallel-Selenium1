...
public class BaseTestSteps {
	...
	public void base_launchChrome() {
		System.out.println("THIS IS CHROME");
		appTestManager = new AppTestManager();
		appTestManager.setBrowser("chrome");
	}
	
	public void base_launchIE() {
		System.out.println("THIS IS IE");
		appTestManager = new AppTestManager();
		appTestManager.setBrowser("ie");
	}
    ...
    public void base_i_am_using_app_url_to_navigate_to_the_test_page() throws Throwable {
    	System.out.println("STEP1 BROWSERTYPE=" + appTestManager.getBrowser());
